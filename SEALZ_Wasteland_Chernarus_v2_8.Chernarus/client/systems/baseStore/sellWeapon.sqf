...
_weapon_value = 25; // This is for weapons that aren't in the basestore stock list. TODO fix the sell price.
...
hint format["You sold your base for $%1", _weapon_value];