...
private ["_CivGrpB","_unitsAlive2","_unitsAlive","_playerPresent","_missionType","_successTextColour","_mainTextColour","_failTextColour","_subTextColour","_picture","_vehicleName","_rad","_centerPos","_missionTimeOut","_missionDelayTime","_missionTriggerRadius","_missionPlayerRadius","_flatAreas","_randomArea","_hint","_startTime","_currTime","_result","_tank"];

//Mission Initialization.
_rad=20000;
_result = 0;
_missionType = "Light Artillery";
...
_hint = parseText format ["<t align='center' color='%2' shadow='2' size='1.75'>Light Artillery Objective</t><br/><t align='center' color='%2'>------------------------------</t><br/><t color='%3' size='1.0'>Starting in %1 Minutes</t>", _missionDelayTime / 60, _mainTextColour, _subTextColour];
...
_result = 0;
_veh = ["GRAD_CDF","GRAD_INS","GRAD_RU"] call BIS_fnc_selectRandom;
...
clientMissionMarkers set [count clientMissionMarkers,["Light_Artillery_Marker",_randomPos,_missionName, "ColorGreen"]];
publicVariable "clientMissionMarkers";
_smallBase1 = _SmallBaseArray select (random (count _SmallBaseArray - 1));
_subBase1 = [_smallBase1, 285, [(_randomPos select 0) - 50, _randomPos select 1, 0]] execVM "server\functions\objectMapper.sqf";
sleep 1;
_CivGrpB = createGroup civilian;
[_CivGrpB,_randomPos]execVM "server\missions\createUnits\smallGroup.sqf";
diag_log format ["#############################Light Mission - Vehicle: %1 Mission: %2 #############################",_vehicleName,_missionName];
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Light Artillery Objective</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>A<t color='%4'> %3</t> Mobile Anti Air Vehicle has been immobilized. Sieze it before your enemies do!</t>", _missionType, _picture, _vehicleName, _mainTextColour, _subTextColour];
[nil,nil,rHINT,_hint] call RE;
_startTime = floor(time);
waitUntil
{
	...
	_unitsAlive = ({alive _x} count units _CivGrpB);
	if (damage _tank == 1) then{_unitsAlive = 0};		
	[_randomPos,_unitsAlive,"Light_Artillery_Marker2","ColorGreen","4"]execVM "scripts\MissionTracker.sqf";	
...
//deleteMarker "Light_Artillery_Marker2";
if(_result == 1) then
{
	//Mission Failed.
    deleteVehicle _tank;
	{deleteVehicle _x;}forEach units _CivGrpB;
    deleteGroup _CivGrpB;	
	{deleteVehicle _x} forEach nearestObjects [_randomPos, _objtoRemoveArray, 200];	
    _hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Light Artillery Objective Failed</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>Objective failed, better luck next time</t>", _missionType, _picture, _vehicleName, _failTextColour, _subTextColour];
	[nil,nil,rHINT,_hint] call RE;
...
{
    if(_x select 0 == "Light_Artillery_Marker") then
    {
