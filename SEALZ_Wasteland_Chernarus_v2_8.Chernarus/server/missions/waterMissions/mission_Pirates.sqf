...
_rndPOS = ["sealzWaterMission1","sealzWaterMission2","sealzWaterMission3","sealzWaterMission4"] call BIS_fnc_selectRandom;
...
//_tank setVehicleInit "nul=[_tank,'Pirate Ship'] execVM 'scripts\pirateTracker.sqf';";
...
[_CivGrpD,_randomPos, _tank]execVM "server\missions\createUnits\Pirates.sqf";
...
if (_unitsAlive < 1) then
	{
		deleteMarker "PirateLeader";
		deleteMarker "PirateAssistant";		
		deleteVehicle _tank;	
	};
