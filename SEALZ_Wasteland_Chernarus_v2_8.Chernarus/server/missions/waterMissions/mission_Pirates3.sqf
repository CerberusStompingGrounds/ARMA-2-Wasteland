...
_rndPOS = ["sealzWaterMission9","sealzWaterMission10","sealzWaterMission11","sealzWaterMission12"] call BIS_fnc_selectRandom;
...
//_tank setVehicleInit "nul=[_tank,'Pirate Vessel'] execVM 'scripts\pirateTracker.sqf';";
...
[_CivGrpD,_randomPos, _tank]execVM "server\missions\createUnits\Pirates3.sqf";
...
if (_unitsAlive < 1) then
	{
		deleteMarker "PirateAssistant3";		
		deleteMarker "PirateLeader3";	
		deleteVehicle _tank;
	};
