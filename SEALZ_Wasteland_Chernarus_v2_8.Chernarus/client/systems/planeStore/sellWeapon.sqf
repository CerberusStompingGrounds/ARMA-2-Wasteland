...
_weapon_value = 25; // This is for weapons that aren't in the planestore stock list. TODO fix the sell price.
...
hint format["You sold your plane for $%1", _weapon_value];