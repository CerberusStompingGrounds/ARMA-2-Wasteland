...
_hint = parseText format ["<t align='center' color='%2' shadow='2' size='1.75'>Heavy Artillery Objective</t><br/><t align='center' color='%2'>------------------------------</t><br/><t color='%3' size='1.0'>Starting in %1 Minutes</t>", _missionDelayTime / 60, _mainTextColour, _subTextColour];
...
_veh = ["MLRS_DES_EP1","MLRS"] call BIS_fnc_selectRandom;
...
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Heavy Artillery Objective</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>A<t color='%4'> %3</t> Artillery Truck has been immobilized. Sieze it before your enemies do!</t>", _missionType, _picture, _vehicleName, _mainTextColour, _subTextColour];
[nil,nil,rHINT,_hint] call RE;

//Add marker to client marker array.
_missionName = format ["%1 Mission",_vehicleName];
clientMissionMarkers set [count clientMissionMarkers,["Artillery_Marker",_randomPos,_missionName, "ColorYellow"]];
...
_CivGrpE = createGroup civilian;
[_CivGrpE,_randomPos]execVM "server\missions\createUnits\midGroup.sqf";
...
waitUntil
{
	...
	_unitsAlive = ({alive _x} count units _CivGrpE);
	if (damage _tank == 1) then{_unitsAlive = 0};	
	[_randomPos,_unitsAlive,"Artillery_Marker2","ColorYellow","6"]execVM "scripts\MissionTracker.sqf";			
...
if(_result == 1) then
{
	//Mission Failed.
    deleteVehicle _tank;
	{deleteVehicle _x;}forEach units _CivGrpE;
	{deleteVehicle _x} forEach nearestObjects [_randomPos, _objtoRemoveArray, 200];		
    deleteGroup _CivGrpE;
    _hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Heavy Artillery Objective Failed</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>Objective failed, better luck next time</t>", _missionType, _picture, _vehicleName, _failTextColour, _subTextColour];
	[nil,nil,rHINT,_hint] call RE;
} else {
	//Mission Complete.
	{deleteVehicle _x;}forEach units _CivGrpE;	
    deleteGroup _CivGrpE;
	{deleteVehicle _x} forEach nearestObjects [_randomPos, _objtoRemoveArray, 200];			
    _hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Heavy Artillery Objective Complete</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>The Artillery Truck has been captured, now go hunt the enemy!</t>", _missionType, _picture, _vehicleName, _successTextColour, _subTextColour];
	[nil,nil,rHINT,_hint] call RE;
...
{
    if(_x select 0 == "Artillery_Marker") then
    {
