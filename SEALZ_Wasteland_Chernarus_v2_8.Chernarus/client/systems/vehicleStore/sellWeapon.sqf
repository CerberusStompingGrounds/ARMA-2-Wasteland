...
_weapon_value = 25; // This is for weapons that aren't in the vehiclestore stock list. TODO fix the sell price.
...
hint format["You sold your vehicle for $%1", _weapon_value];