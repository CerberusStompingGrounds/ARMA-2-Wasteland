...
class helishopd {
	...
	onLoad = "[0] execVM 'client\systems\heliStore\populateheliStore.sqf'";
	...
	class controls {
		...
		{
			idc = helishop_heli_list;
			onLBSelChanged = "[] execvm 'client\systems\heliStore\heliInfo.sqf'";
		...
		{
			idc = -1;
			onButtonClick = "[] execVM 'client\systems\heliStore\addToCart.sqf'";
			text = "Add";
		...
		{
			idc = -1;
			onButtonClick = "[] execVM 'client\systems\heliStore\removeFromCart.sqf'";
			text = "Remove";
		...
		{
			idc = -1;
			onButtonClick = "[1] execVM 'client\systems\heliStore\buyhelis.sqf'";
			text = "Buy to Heli Pad";
		...
		{
			idc = -1;
			onButtonClick = "[0] execVM 'client\systems\heliStore\buyhelis.sqf'";
			text = "Buy to Heli Pad and take pilot seat";
		...
		{
			idc = -1;
			onButtonClick = "[] execVM 'client\systems\heliStore\sellWeapon.sqf'";
		...
		{
			idc = -1;
			onButtonClick = "[0] execVM 'client\systems\heliStore\populateheliStore.sqf'";
			text = "Choppers";
