#include "vehiclestoreDefines.sqf"

class vehicleshopd {

	idd = vehicleshop_DIALOG;
	movingEnable = true;
	...
	class controls {
		...
		{
			idc = -1;
			onButtonClick = "[] execVM 'client\systems\vehicleStore\addToCart.sqf'";
			text = "Add";
		...
		{
			idc = -1;
			onButtonClick = "[] execVM 'client\systems\vehicleStore\removeFromCart.sqf'";
			text = "Remove";
		...
		{
			idc = -1;
			onButtonClick = "[] execVM 'client\systems\vehicleStore\sellWeapon.sqf'";
