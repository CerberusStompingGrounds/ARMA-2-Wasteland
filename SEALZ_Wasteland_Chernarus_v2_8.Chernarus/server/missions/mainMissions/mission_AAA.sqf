...
private ["_CivGrpD","_unitsAlive2","_unitsAlive","_playerPresent","_missionType","_successTextColour","_mainTextColour","_failTextColour","_subTextColour","_picture","_vehicleName","_rad","_centerPos","_missionTimeOut","_missionDelayTime","_missionTriggerRadius","_missionPlayerRadius","_flatAreas","_randomArea","_hint","_startTime","_currTime","_result","_tank"];

//Mission Initialization.
_rad=20000;
_result = 0;
_missionType = "Heavy Anti Air";
...
_hint = parseText format ["<t align='center' color='%2' shadow='2' size='1.75'>Heavy Anti Air Objective</t><br/><t align='center' color='%2'>------------------------------</t><br/><t color='%3' size='1.0'>Starting in %1 Minutes</t>", _missionDelayTime / 60, _mainTextColour, _subTextColour];
...
_veh = ["ZSU_CDF","ZSU_INS","2S6M_Tunguska","ZSU_TK_EP1"] call BIS_fnc_selectRandom;
...
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Heavy Anti Air Objective</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>A<t color='%4'> %3</t> Heavy Anti Air Vehicle has been immobilized. Sieze it before your enemies do!</t>", _missionType, _picture, _vehicleName, _mainTextColour, _subTextColour];
[nil,nil,rHINT,_hint] call RE;
//Add marker to client marker array.
_missionName = format ["%1 Mission",_vehicleName];
clientMissionMarkers set [count clientMissionMarkers,["AAA_Marker",_randomPos,_missionName, "ColorYellow"]];
...
[_CivGrpD,_randomPos]execVM "server\missions\createUnits\midGroup.sqf";
...
waitUntil
{
	...
	[_randomPos,_unitsAlive,"AAA_Marker2","ColorYellow","6"]execVM "scripts\MissionTracker.sqf";		
...
if(_result == 1) then
{
    ...
    _hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Heavy Anti Air Objective Failed</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>Objective failed, better luck next time</t>", _missionType, _picture, _vehicleName, _failTextColour, _subTextColour];
	[nil,nil,rHINT,_hint] call RE;
} else {
	//Mission Complete.
	{deleteVehicle _x;}forEach units _CivGrpD;	
...
{
    if(_x select 0 == "AAA_Marker") then
    {
